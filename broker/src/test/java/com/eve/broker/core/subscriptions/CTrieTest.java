 ...
 */
package com.eve.broker.core.subscriptions;
...
import static com.eve.broker.core.subscriptions.Topic.asTopic;
...
public class CTrieTest {
    ...
    public void givenTreeWithSomeNodeHierarchWhenRemoveContainedSubscriptionThenNodeIsUpdated() {
        ...
        Assertions.assertThat(matchingSubs).contains(expectedMatchingsub);
    }
    ...
    public void givenTreeWithSomeNodeHierarchWhenRemoveContainedSubscriptionSmallerThenNodeIsNotUpdated() {
        ...
        Assertions.assertThat(matchingSubs1).contains(expectedMatchingsub1);
        final Subscription expectedMatchingsub2 = new Subscription("TempSensor1", asTopic("/temp/2"), MqttQoS.AT_MOST_ONCE);
        Assertions.assertThat(matchingSubs2).contains(expectedMatchingsub2);
    }
    ...
    public void testRemovalInnerTopicOffRootSameClient() {
        ...
        Assertions.assertThat(matchingSubs3).doesNotContain(expectedMatchingsub1);
        Assertions.assertThat(matchingSubs4).contains(expectedMatchingsub2);
    }
    ...
    public void testRemovalOuterTopicOffRootDiffClient() {
        ...
        Assertions.assertThat(matchingSubs3).contains(expectedMatchingsub1);
        Assertions.assertThat(matchingSubs4).doesNotContain(expectedMatchingsub2);
    }
}
