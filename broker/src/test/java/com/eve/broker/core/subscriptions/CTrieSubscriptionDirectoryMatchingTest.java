...
import com.eve.broker.core.ISubscriptionsRepository;
...
import static com.eve.broker.core.subscriptions.CTrieTest.clientSubOnTopic;
...
//        System.out.println(sut.dumpTree());
    ...
    public void removeSubscription_sameClients_subscribedSameTopic() {
        ...
        Assertions.assertThat(matchingSubscriptions).isEmpty();
    }
    ...
    public void duplicatedSubscriptionsWithDifferentQos() {
        ...
        Assertions.assertThat(subscriptions).contains(client1SubQoS2);
        Assertions.assertThat(subscriptions).contains(client2Sub);
